...
map_cel_t map_terrein_pad[CEL_MAAT] = {
    [0 ...(0XFF - 1)] = {.r = 100, .b = 100, .g = 150, .a = 100}};
map_cel_t map_terrein_boom[CEL_MAAT] = {
    [0 ...(0XFF - 1)] = {.r = 50, .b = 50, .g = 255, .a = 100}};
map_cel_t map_terrein_water[CEL_MAAT] = {
    [0 ...(0XFF - 1)] = {.r = 50, .b = 255, .g = 50, .a = 100}};
map_cel_t *terrein_vertaler[] = {
    [0] = map_terrein_pad,
    [1] = map_terrein_boom,
    [2] = map_terrein_water,
};
...
map_t *map_alloceer(void) { return malloc(sizeof(map_t)); }

void map_dealloceer(map_t *map) { free(map); }
...
uint32_t map_compile(FILE *ingang, FILE *uitgang) {
    ...
    uint32_t geschreven =
        ...
        map_lees_sector(ingang, "__start_eigenschappen",
                        "__eind_eigenschappen", map.eigenschappen);
    map_schrijf_map(uitgang, &map);
    return geschreven;
}
